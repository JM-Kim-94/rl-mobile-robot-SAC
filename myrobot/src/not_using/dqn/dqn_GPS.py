...
from dqn.env.env_dqn_GPS import Env
import torch
...
class Brain():
    def __init__(self, state_size, action_size):
        ...
        #self.model = torch.load("/home/jm-kim/catkin_ws/src/myrobot/save_model/0526_seungmin_train_2/IC_world_980.pt") # 학습 잘된거
