...
class respawn_goal():
    ...
    def goal_def(self, delete):
        ...
        while True:
            ...
            x, y = np.random.randint(-70,70)/10, np.random.randint(-70,70)/10
...
class Env():
    ...
    def setReward(self, state, done, action):
        ...
        #if (obstacle_min_range < 1.2):
        #    obstacle_reward = 3*abs(d_angle)
        #    #obstacle_reward = -2 - 2/obstacle_min_range
        ...
        reward = ((round(yaw_reward[action] * 7, 2)) * distance_rate)
